...
class DataQualityChecker:
    ...
    def __init__(self, parquet_store: ParquetStore | None = None):
        """
        初始化质量检查器
            ...
            if low > o or low > c:
                issues.append(
                    QualityIssue(
                        ...
                        severity="error",
                        timestamp=ts,
                        description=f"Low ({low}) > Open ({o}) or Close ({c})",
                        details={"open": o, "high": h, "low": low, "close": c},
                    )
                )
                ...
                issues.append(
                    QualityIssue(
                        ...
                        details={
                            ...
                            "multiplier": row["volume"] / mean_vol
                            if mean_vol > 0
                            else 0,
                        },
                    )
